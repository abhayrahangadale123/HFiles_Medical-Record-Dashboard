...
"[project]/app/compontes/Login.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function LoginPage() {
    ...
    const handleSubmit = async (e)=>{
        e.preventDefault();
        if (!email || !password) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error('Email + password required');
            return;
        }
        try {
            setLoading(true);
            ...
            if (!res.ok) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error(body?.message || `Login failed (${res.status})`);
                return;
            }
            const token = body?.token;
            const user = body?.user;
            if (!token || !user) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].error('Invalid login response from server');
                return;
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a86a6193._.js.map