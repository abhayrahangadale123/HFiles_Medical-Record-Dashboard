...
"[project]/app/compontes/Deshbordaaa.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function DashboardPage() {
    ...
    const handleUpload = async ()=>{
        if (!selectedFile || !fileName.trim() || !fileType) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Fill all fields');
            return;
        }
        const formData = new FormData();
        formData.append('userId', userId.toString());
        ...
        try {
            ...
            if (res.ok) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].success('File uploaded!');
                setSelectedFile(null);
                setFileName('');
                setFileType('');
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error(`Upload failed: ${res.status} - ${typeof body === 'string' ? body : body?.message || ''}`);
            }
        } catch (err) {
            console.error('Upload error', err);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error('Network error during upload');
        } finally{
            setUploading(false);
        }
    };
...
_s(DashboardPage, "oLihCqzJKXI+nPaYglr8xd47oyg=");
_c = DashboardPage;
var _c;
...
//# sourceMappingURL=app_compontes_Deshbordaaa_tsx_7d43f3a4._.js.map